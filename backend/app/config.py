...
# Note: get_pricing() checks the ":free" suffix before consulting this table,
# so the non-zero numbers below are never actually used for that model —
# kept only as a record of its real paid-tier cost.
